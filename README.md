...
<p align="center"> 
<img src="ss_gh_actions_demo.png" alt="Screenshot" title="Screenshot" width="90%">
<br>
<br>
[Screenshot: GitHub Actions UI showing 4 parallel workflow results]
</p>
...
1. process all files, new and old
1. specify directories in events (configured for workflows in this repo, reduces cost by pruning build matrix)
1. calculate the change list. Two different techniques are:

a. [Get changed files in github actions](https://dev.to/scienta/get-changed-files-in-github-actions-1p36)
a. [Is it possible to run the job only when a specific file changes?](https://github.community/t/is-it-possible-to-run-the-job-only-when-a-specific-file-changes)
